...
本文件說明如何使用 `start_full_analysis_botsort.ps1` 腳本，執行一個從影片追蹤、特徵提取到餘弦距離分析的完整流程。
...
**範例**：
```powershell
.\start_full_analysis_botsort.ps1 -VIDEO "monkey_video_1.mp4" -TRACK_MODEL "best.pt" -EMBED_MODEL "yolo11n-cls.pt" -OUTPUT "monkey_analysis"
```
...
- `start_full_analysis_botsort.ps1`: **您需要執行的主要啟動腳本**。
